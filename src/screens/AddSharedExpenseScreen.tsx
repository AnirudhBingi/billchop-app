...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'AddSharedExpense'>;
type RouteProp_AddSharedExpense = RouteProp<RootStackParamList, 'AddSharedExpense'>;
...
export default function AddSharedExpenseScreen() {
  ...
  const route = useRoute<RouteProp_AddSharedExpense>();
  ...
  const [expenseType, setExpenseType] = useState<'friends' | 'group'>(groupId ? 'group' : 'friends');
  ...
  const availableUsers = expenseType === 'group' && selectedGroup
  ...
  const handleSave = () => {
    ...
    const expense: Expense = {
      ...
      groupId: expenseType === 'group' ? selectedGroupId : undefined,
      date: new Date(),
      createdAt: new Date(),
      isDraft,
    };
  ...
  const handleTypeChange = (type: 'friends' | 'group') => {
    setExpenseType(type);
    setSelectedGroupId('');
      ...
      >
        ...
        <GlassCard className="mb-4">
          ...
          <View className="flex-row">
            <Pressable
              onPress={() => handleTypeChange('friends')}
              className={cn(
            ...
            >
              <View className="items-center">
                <Ionicons 
                  ...
                  size={28} 
                  color={expenseType === 'friends' ? "#3B82F6" : isDark ? "#9CA3AF" : "#6B7280"} 
                />
                <Text className={cn(
                  "font-semibold mt-2 text-center",
                  expenseType === 'friends' ? "text-blue-500" : isDark ? "text-white" : "text-gray-900"
                )}>
            ...
            >
              <View className="items-center">
                <Ionicons 
                  name="home-outline" 
                  size={28} 
                  color={expenseType === 'group' ? "#10B981" : isDark ? "#9CA3AF" : "#6B7280"} 
                />
                <Text className={cn(
                  "font-semibold mt-2 text-center",
                  expenseType === 'group' ? "text-green-500" : isDark ? "text-white" : "text-gray-900"
                )}>
                  Group Expense
                </Text>
                <Text className={cn(
          ...
          <GlassCard className="mb-4">
            ...
            {groups.length > 0 ? (
              ...
              <View className="items-center py-4">
                <Ionicons name="people-outline" size={32} color={isDark ? "#6B7280" : "#9CA3AF"} />
                <Text className={cn(
